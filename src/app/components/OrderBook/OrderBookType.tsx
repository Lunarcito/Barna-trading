...
export function createOrderBook(input: { [key: string]: any },tradingPair:TradingPairType, lastPrice:string): OrderBookType {
  ...
  return { bids: bidsItems.slice(0, 12), asks: asksItems.slice(0, 12), tradingPair: tradingPair, lastPrice: lastPrice};
}
