...
const OrderBookItem: React.FC<OrderBookItemType> = ({ price, quantity }) => {
  return (
    <div className="grid grid-cols-3 h-7">
      <div data-testid="price" className="text-center text-sm">
        {formatMoney(price)}
      </div>
      <div data-testid="quantity" className="text-center text-sm">
        {formatDecimal(quantity)}
      </div>
      <div data-testid="total" className="text-right text-sm">
